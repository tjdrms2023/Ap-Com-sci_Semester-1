...
public class gameFrame extends JFrame implements KeyListener,Runnable
{
	...
	//variables for images of enemies
	int ew;
	int eh;
	
	//variables for images of missiles
	int mw; 
	int mh; 
	...
	{ 
		...
		//value (width and height) of enemies
...
//   ->While mutiple threads would be helpful in executing many processes, but it might cause lags.
	...
	public void MissileProcess()
	{
		...
		for(int i=0;i<MissList.size(); i++)
		{
			...
			//If the location of missile and enemies are identical, remove.
			for(int j=0; j<EnemyList.size();i++)
			{
				en = (Enemy)EnemyList.get(i); 
				//determine whether they crash or not
	...
	//determine whether enemies and missiles are crash or not.
	//The hardest part; the only one we actually just copied and pasted
	//because this formula was too hard for us to create our own.
